...
If you need basic setup steps, refer to [Configure MCP servers](xref:mcp-configure). For Unity MCP Configuration page settings, refer to [Assistant Extensions page reference](xref:mcp-panel).
